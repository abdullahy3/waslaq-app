...
1. `account` - 85 edges
2. `account` - 85 edges
3. `WebPSafeFree()` - 83 edges
4. `product` - 67 edges
5. `product` - 67 edges
6. `WebPSafeMalloc()` - 62 edges
7. `community` - 62 edges
8. `community` - 62 edges
9. `vendor` - 56 edges
10. `vendor` - 56 edges
...
- `FastSLog2Slow_C()` --calls--> `BitsLog2Floor()`  [INFERRED]
  ios/Pods/libwebp/src/dsp/lossless_enc.c → ios/Pods/libwebp/src/utils/utils.h
- `PaletteCompareColorsForQsort()` --calls--> `WebPMemToUint32()`  [INFERRED]
...
Cohesion: 0.01
Nodes (210): anyId, authorId, authorIdBetween, authorIdContains, authorIdEndsWith, authorIdEqualTo, authorIdGreaterThan, authorIdIsEmpty (+202 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (190): anyId, bytesCount, cachedAt, cachedAtBetween, cachedAtEqualTo, cachedAtGreaterThan, cachedAtLessThan, cachedAtProperty (+182 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (171): anyId, bytesCount, cachedAt, cachedAtBetween, cachedAtEqualTo, cachedAtGreaterThan, cachedAtLessThan, cachedAtProperty (+163 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (151): anyId, avatarUrl, avatarUrlBetween, avatarUrlContains, avatarUrlEndsWith, avatarUrlEqualTo, avatarUrlGreaterThan, avatarUrlIsEmpty (+143 more)
...
Cohesion: 0.02
Nodes (86): File?, package:file_picker/file_picker.dart, ../../providers/vendor_providers.dart, _amountCtrl, _answerCtrl, _answeringId, badgeKey, balance (+78 more)
...
Cohesion: 0.06
Nodes (30): amount, cartId, CheckoutSession, CheckoutStatus, CheckoutStep, company, copyWith, createdAt (+22 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (67): ../features/account/ui/screens/account_screen.dart, ../features/account/ui/screens/orders_screen.dart, ../features/account/ui/screens/privacy_policy_screen.dart, ../features/account/ui/screens/refund_policy_screen.dart, ../features/account/ui/screens/saved_items_screen.dart, ../features/account/ui/screens/settings/account_settings_screen.dart, ../features/account/ui/screens/settings/address_book_screen.dart, ../features/account/ui/screens/settings/app_info_settings_screen.dart (+59 more)
...
Cohesion: 0.14
Nodes (44): AppendToMemBuffer(), ChangeState(), CheckMemBufferMode(), ClearMemBuffer(), CopyParts0Data(), DecodePartition0(), DecodeRemaining(), DecodeVP8FrameHeader() (+36 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (46): CategoryCacheQueryFilter, CategoryCacheQueryLinks, CategoryCacheQueryObject, CategoryCacheQueryProperty, CategoryCacheQuerySortBy, CategoryCacheQuerySortThenBy, CategoryCacheQueryWhere, CategoryCacheQueryWhereDistinct (+38 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (48): _buildBody, _buildPlaceholder, _buildSearchBar, _communities, community, _CommunityCard, _CommunityHit, communitySlug (+40 more)
...
Cohesion: 0.12
Nodes (42): ComplexMask_SSE2(), DC16_SSE2(), DC16NoLeft_SSE2(), DC16NoTop_SSE2(), DC16NoTopLeft_SSE2(), DC8uv_SSE2(), DC8uvNoLeft_SSE2(), DC8uvNoTop_SSE2() (+34 more)
...
Cohesion: 0.14
Nodes (39): DC16_SSE2(), DC16Mode_SSE2(), DC16NoLeft_SSE2(), DC16NoTop_SSE2(), DC16NoTopLeft_SSE2(), DC4_SSE2(), DC8uv_SSE2(), DC8uvMode_SSE2() (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.15
Nodes (12): core/crashlytics/crash_reporter.dart, CheckoutRepository, extractOrderId, getOrder, getShippingOptions, initPaymentSession, isFailureUrl, isSuccessUrl (+4 more)
...
Cohesion: 0.07
Nodes (28): GetResidualCost_C(), GetResidualCost_MIPS32(), SetResidualCoeffs_MIPS32(), VP8EncDspCostInitMIPS32(), GetResidualCost_MIPSdspR2(), VP8EncDspCostInitMIPSdspR2(), GetResidualCost_NEON(), SetResidualCoeffs_NEON() (+20 more)

### Community 74 - "Community 74"
Cohesion: 0.10
Nodes (21): home, browse_categories, drawer_browse, drawer_community, drawer_create_community, drawer_news, drawer_popular, drawer_sign_in_hint (+13 more)
...
Cohesion: 0.06
Nodes (34): After code generation — ALWAYS run these, 📱 App Overview, Bell badge (BellIconWithBadge), Cart sync, 🛍️ Commerce Integration, ✅ Confirmed Working (device-tested), Dart async patterns, 💻 Dev Environment (MacBook M1 Pro) (+26 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (33): After code generation — ALWAYS run these, 📱 App Overview, Bell badge (BellIconWithBadge), Cart sync, 🛍️ Commerce Integration, ✅ Confirmed Working (device-tested), Dart async patterns, 💻 Dev Environment (MacBook M1 Pro) (+25 more)
...
Cohesion: 0.06
Nodes (31): messages, connect_vendors_buyers, could_not_connect, could_not_open_chat, deleted, follow_someone, input_placeholder, last_seen (+23 more)
...
Cohesion: 0.11
Nodes (23): DC4(), DCMode16(), DCMode8(), Disto16x16_MIPSdspR2(), Disto4x4_MIPSdspR2(), HD4(), HE4(), HU4() (+15 more)

### Community 93 - "Community 93"
Cohesion: 0.10
Nodes (20): AddGreenToBlueAndRed_NEON(), Average2_NEON(), Average2_u8_NEON(), Average3_NEON(), ClampedAddSubtractHalf_NEON(), ConvertBGRAToRGBA_NEON(), DoGreenShuffle_NEON(), Predictor13_NEON() (+12 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (25): Average2_m128i(), Average2_SSE2(), Average2_uint32_16_SSE2(), Average2_uint32_SSE2(), Average3_SSE2(), Average4_SSE2(), ClampedAddSubtractFull_SSE2(), ClampedAddSubtractHalf_SSE2() (+17 more)
...
Cohesion: 0.08
Nodes (25): AppColors get, BuildContext, BuildContextTranslationsExtension, static const AppColors, _, AppColors, background, border (+17 more)

### Community 107 - "Community 107"
Cohesion: 0.19
Nodes (24): abs_mips32(), do_filter2(), do_filter4(), do_filter6(), FilterLoop24(), FilterLoop26(), hev(), HFilter16() (+16 more)
...
Cohesion: 0.15
Nodes (16): Average2(), Average3(), Average4(), ClampedAddSubtractFull(), ClampedAddSubtractHalf(), Predictor10_MIPSdspR2(), Predictor11_MIPSdspR2(), Predictor12_MIPSdspR2() (+8 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (21): authors, Your Company, dependencies, Flutter, description, homepage, license, file (+13 more)

### Community 124 - "Community 124"
Cohesion: 0.14
Nodes (22): PageRouteInfo, AboutRoute, AccountSettingsRoute, AddressBookRoute, AppearanceSettingsRoute, AppInfoSettingsRoute, CategoriesRoute, CheckoutRoute (+14 more)
...
Cohesion: 0.22
Nodes (8): category, browse_categories, for_you, no_subcategories, products_coming_soon, recommended, select_category, subcategories
...
Cohesion: 0.10
Nodes (20): authors, Hitesh Kumar Saini, dependencies, Flutter, description, homepage, license, file (+12 more)
...
Cohesion: 0.11
Nodes (14): VP8LDspInitMIPSdspR2(), TransformColorInverse_MSA(), VP8LDspInitMSA(), VP8LDspInitNEON(), VP8LDspInitSSE2(), VP8LDspInitSSE41(), VP8LDspInit(), WEBP_DSP_INIT_FUNC (+6 more)

### Community 141 - "Community 141"
Cohesion: 0.33
Nodes (18): MultHi(), ConvertRGBA32ToUV_NEON(), VP8Clip8(), VP8ClipUV(), VP8RGBToU(), VP8RGBToV(), VP8YuvToArgb(), VP8YUVToB() (+10 more)
...
Cohesion: 0.11
Nodes (16): VP8LEncDspInitMIPS32(), VP8LEncDspInitMIPSdspR2(), TransformColor_MSA(), VP8LEncDspInitMSA(), VP8LEncDspInitNEON(), VP8LEncDspInitSSE2(), VP8LEncDspInitSSE41(), VP8LEncDspInit() (+8 more)

### Community 147 - "Community 147"
Cohesion: 0.13
Nodes (14): apiBase, AppConfig, googleWebClientId, keyFirebaseToken, keyMedusaJwt, keySignedOut, palestineRegionId, publishableKey (+6 more)
...
Cohesion: 0.17
Nodes (9): Clip8(), YuvToArgb(), YuvToBgr(), YuvToBgra(), YuvToRgb(), YuvToRgb565(), YuvToRgba(), YuvToRgba4444() (+1 more)
...
Cohesion: 0.27
Nodes (15): DoGradientFilter_NEON(), DoHorizontalFilter_NEON(), DoVerticalFilter_NEON(), GradientFilter_NEON(), GradientPredictDirect_NEON(), GradientPredictInverse_NEON(), GradientPredictor_C(), GradientUnfilter_NEON() (+7 more)

### Community 158 - "Community 158"
Cohesion: 0.26
Nodes (15): DoGradientFilter_SSE2(), DoHorizontalFilter_SSE2(), DoVerticalFilter_SSE2(), GradientFilter_SSE2(), GradientPredictDirect_SSE2(), GradientPredictInverse_SSE2(), GradientPredictor_SSE2(), GradientUnfilter_SSE2() (+7 more)

### Community 159 - "Community 159"
Cohesion: 0.24
Nodes (11): VP8LFastSLog2(), CombinedShannonEntropy_C(), FastSLog2Slow_C(), GetCombinedEntropyUnrefined_C(), GetEntropyUnrefined_C(), GetEntropyUnrefinedHelper(), ShannonEntropy_C(), VP8LBitEntropyInit() (+3 more)

### Community 160 - "Community 160"
Cohesion: 0.15
Nodes (10): Average2_m128i(), BundleColorMap_SSE2(), CombinedShannonEntropy_SSE2(), GetSumAbsDiff32_SSE2(), PredictorSub10_SSE2(), PredictorSub11_SSE2(), PredictorSub5_SSE2(), VP8LBundleColorMap_C() (+2 more)
...
Cohesion: 0.13
Nodes (14): 1. `lib/core/providers/preferences_provider.dart`, 1. `lib/features/social/data/models/social_models.dart`, 2. `lib/features/social/providers/social_providers.dart`, 2. `lib/main.dart`, 3. `lib/features/social/feed/ui/screens/feed_screen.dart`, `community_screen.dart`, and `user_profile_screen.dart`, 3. `lib/shared/widgets/biometric_guard.dart`, 4. `lib/features/social/post/ui/screens/post_detail_screen.dart`, CLAUDE Flutter Session Update & Patch Log (+6 more)

### Community 163 - "Community 163"
Cohesion: 0.11
Nodes (17): ../../../core/storage/isar/category_cache.dart, ../../../core/storage/isar/product_cache.dart, ../../../core/storage/isar_service.dart, dart:convert, count, _fetchAndCacheCategories, _fetchAndCacheProducts, getCategories (+9 more)
...
Cohesion: 0.27
Nodes (13): HuffmanTree, HuffmanTreeCode, HuffmanTreeToken, CodeRepeatedValues(), CodeRepeatedZeros(), ConvertBitDepthsToSymbols(), GenerateOptimalTree(), OptimizeHuffmanForRle() (+5 more)
...
Cohesion: 0.14
Nodes (13): isar/category_cache.dart, isar/feed_post_cache.dart, isar/product_cache.dart, isar/user_profile_cache.dart, isar/vendor_cache.dart, package:isar/isar.dart, package:path_provider/path_provider.dart, static Isar? (+5 more)
...
Cohesion: 0.42
Nodes (11): AllocateAlphaPlane(), ALPHDecode(), ALPHDelete(), ALPHInit(), ALPHNew(), VP8DecompressAlphaRows(), WebPDeallocateAlphaMemory(), ALPHDecoder (+3 more)

### Community 186 - "Community 186"
Cohesion: 0.26
Nodes (6): GetCombinedEntropyUnrefined_MIPS32(), GetEntropyUnrefined_MIPS32(), GetEntropyUnrefinedHelper(), VP8LBitEntropy, VP8LStreaks, WEBP_INLINE
...
Cohesion: 0.36
Nodes (11): WEBP_INLINE, SmoothParams, ApplyFilter(), CleanupParams(), clip_8b(), CountLevels(), HFilter(), InitCorrectionLUT() (+3 more)

### Community 190 - "Community 190"
Cohesion: 0.20
Nodes (12): BaseAppLocale, BaseAppLocaleUtils, BaseFlutterLocaleSettings, BaseTranslationProvider, BaseTranslations, AppLocale, AppLocaleUtils, LocaleSettings (+4 more)

### Community 191 - "Community 191"
Cohesion: 0.33
Nodes (10): CPUFeature, AndroidCPUInfo(), armCPUInfo(), CheckSlowModel(), GetCPUInfo(), mipsCPUInfo(), wasmCPUInfo(), x86CPUInfo() (+2 more)
...
Cohesion: 0.31
Nodes (10): Flatten(), FlattenARGB(), IsTransparentARGBArea(), MakeARGB32(), SmoothenBlock(), WebPBlendAlpha(), WebPCleanupTransparentArea(), WebPReplaceTransparentPixels() (+2 more)
...
Cohesion: 0.38
Nodes (9): Disto16x16_SSE41(), Disto4x4_SSE41(), DoQuantizeBlock_SSE41(), Quantize2Blocks_SSE41(), QuantizeBlock_SSE41(), QuantizeBlockWHT_SSE41(), TTransform_SSE41(), VP8Matrix (+1 more)

### Community 197 - "Community 197"
Cohesion: 0.20
Nodes (10): VP8FiltersInitMIPSdspR2(), VP8FiltersInitMSA(), VP8FiltersInitNEON(), VP8FiltersInitSSE2(), VP8FiltersInit(), WEBP_DSP_INIT_FUNC, WEBP_TSAN_IGNORE_FUNCTION, WEBP_TSAN_IGNORE_FUNCTION (+2 more)

### Community 198 - "Community 198"
Cohesion: 0.36
Nodes (8): CollectColorBlueTransforms_MIPSdspR2(), CollectColorRedTransforms_MIPSdspR2(), ColorTransformDelta(), TransformColor_MIPSdspR2(), TransformColorBlue(), TransformColorRed(), VP8LMultipliers, WEBP_INLINE

### Community 199 - "Community 199"
Cohesion: 0.20
Nodes (9): ConvertBGRAToBGR_NEON(), ConvertBGRAToRGB_NEON(), ConvertBGRAToBGR_SSE2(), ConvertBGRAToBGR_SSE41(), ConvertBGRAToRGB_SSE41(), TransformColorInverse_SSE41(), VP8LConvertBGRAToBGR_C(), VP8LConvertBGRAToRGB_C() (+1 more)
...
Cohesion: 0.22
Nodes (8): @freezed, AuthState, authenticated, error, initial, loading, unauthenticated, package:freezed_annotation/freezed_annotation.dart

### Community 203 - "Community 203"
Cohesion: 0.36
Nodes (10): AsyncValue, Family, OrderDetailFamily, PaginatedProductsFamily, ProductDetailFamily, ProductListFamily, CommunityFamily, FeedPostsNotifierFamily (+2 more)

### Community 204 - "Community 204"
Cohesion: 0.28
Nodes (9): CollectHistogram_SSE2(), FTransform2_SSE2(), FTransform_SSE2(), FTransformPass1_SSE2(), FTransformPass2_SSE2(), FTransformWHT_SSE2(), FTransformWHTRow_SSE2(), __m128i (+1 more)
...
Cohesion: 0.25
Nodes (8): ColorCodeToMultipliers(), ColorTransformDelta(), TransformColorInverse_MIPSdspR2(), TransformColorInverse_SSE2(), VP8LTransformColorInverse_C(), VP8LMultipliers, VP8LMultipliers, VP8LMultipliers

### Community 215 - "Community 215"
Cohesion: 0.32
Nodes (7): func_hadd_sh_s32(), func_hadd_sw_s32(), func_hadd_uh_u32(), WEBP_INLINE, v4i32, v8i16, v8u16

### Community 216 - "Community 216"
Cohesion: 0.36
Nodes (4): copy_dir(), install_xcframework(), select_slice(), isar_flutter_libs-xcframeworks.sh script
...
Cohesion: 0.43
Nodes (7): ColorSpaceInverseTransform_C(), VP8LAddPixels(), PredictorAdd0_C(), PredictorAdd1_C(), PredictorInverseTransform_C(), VP8LInverseTransform(), VP8LTransform
...
Cohesion: 0.52
Nodes (5): clip_NEON(), SharpYuvFilterRow16_NEON(), SharpYuvFilterRow32_NEON(), SharpYuvFilterRow_NEON(), SharpYuvUpdateY_NEON()

### Community 225 - "Community 225"
Cohesion: 0.29
Nodes (6): 1. `build_runner` exit code, 2. `flutter analyze`, 3. APK built path and timestamp, 4. Every file modified with exact changes made, 5. Any corrections made and why, WaslaQ UI Refactor Report
...
Cohesion: 0.33
Nodes (6): Isar, GetCategoryCacheCollection, GetFeedPostCacheCollection, GetProductCacheCollection, GetUserProfileCacheCollection, GetVendorCacheCollection

### Community 231 - "Community 231"
Cohesion: 0.33
Nodes (6): CategoryCacheByIndex, FeedPostCacheByIndex, ProductCacheByIndex, UserProfileCacheByIndex, VendorCacheByIndex, IsarCollection
...
Cohesion: 0.60
Nodes (5): RestoreContext(), SaveContext(), VP8BitReader, VP8Decoder, MBContext

### Community 234 - "Community 234"
Cohesion: 0.60
Nodes (4): VP8L32bToPlanar_SSE41(), VP8PlanarTo24b_SSE41(), __m128i, WEBP_INLINE

### Community 235 - "Community 235"
Cohesion: 0.70
Nodes (5): DoQuantizeBlock_SSE2(), Quantize2Blocks_SSE2(), QuantizeBlock_SSE2(), QuantizeBlockWHT_SSE2(), VP8Matrix

### Community 236 - "Community 236"
Cohesion: 0.40
Nodes (4): SharpYuvConversionMatrix, SharpYuvOptions, SHARPYUV_INLINE, SharpYuvOptionsInit()
...
Cohesion: 0.40
Nodes (4): format, formatInt, formatWithSeparator, ILSFormatter

### Community 240 - "Community 240"
Cohesion: 0.50
Nodes (4): WebPISetIOHooks(), VP8IoPutHook, VP8IoSetupHook, VP8IoTeardownHook
...
Cohesion: 0.50
Nodes (3): fromJson, RefundDetailsModel, toJson

### Community 245 - "Community 245"
Cohesion: 0.50
Nodes (3): addNotifRefreshListener, notifyRefreshListeners, removeNotifRefreshListener

### Community 247 - "Community 247"
Cohesion: 0.50
Nodes (3): DateHelpers, formatOrderDate, timeAgo
